...
// We can easily encode a string or an array buffer into base64 using the base64.encodeBase64 method.
const base64Encoded = base64.encodeBase64("somestringtoencode");
console.log(base64.encodeBase64(new Uint8Array([1, 32, 67, 120, 19])));

// We can then decode base64 into a byte array using the decodeBase64 method.
const base64Decoded = base64.decodeBase64(base64Encoded);
...
const hexEncoded = hex.encodeHex(arrayBuffer);
...
const hexDecoded = hex.decodeHex(hexEncoded);
